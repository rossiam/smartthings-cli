...
import { checkServerIdentity, chooseHubDrivers } from '../../../lib/command/util/logcat-util.js'
...
const handler = async (argv: ArgumentsCamelCase<CommandArgs>): Promise<void> => {
	...
	spinner.start('looking up drivers')
	// TODO: do we even need the spinner here?
	...
	const sourceTimeoutId = setTimeout(() => {
		...
		try {
			...
			if (error instanceof Error) {
				// TODO: what did this method actually do?
				// Errors.handle(error)
